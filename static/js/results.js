    ...
    $.ajax({
        ...
        success: function(data) {
          $.each($.parseJSON(data), function (key, value) {
                ...
                if (value === 'claimed'){
                    doi_element.removeClass('claim-none');
                    doi_element.addClass('claim-ok');
                    doi_element.click(claimOkClickFn);
                    doi_element.find('span').text('In your record');
                }
                else{
                    doi_element.removeClass('claim-ok');
                    doi_element.addClass('claim-none');
                    doi_element.click(claimNoneClickFn);
                    doi_element.find('span').text('Add to ORCID');
                }

          })
        },
        error: function(data) {
          console.log("Error while updating ORCID dois")
        }
    });
